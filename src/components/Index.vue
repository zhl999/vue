    ...
    <div>
      ...
      <div class="soubg">
        <div class="sou">
          ...
          <!--End 所在收货地区 End-->
          <span class="fr">
        	<span class="fl">你好，请<a href="">登录</a>&nbsp; <a href="" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
            ...
            <div class="leftNav">
              <ul>
                <li v-for="v in ma">
                  ...
                  <div class="zj">
                    <div class="zj_l">
                      <div class="zj_l_c" v-for="ar in v.sos">
                        <h2>{{ar.cat_name}}</h2>
                        <a href="#" v-for="as in ar.sos">{{as.cat_name}}</a>
                      </div>
                    </div>
                    <div class="zj_r">
...
<script>
    export default {
        ...
        mounted () {
            axios.get('http://localhost/blog/public/index.php/personal/floor')
                .then(response => (this.msg = response.data))
                .catch(function (error) {
                    console.log(error);
                });
            axios.get('http://localhost/blog/public/index.php/personal/show')
